  ...
  try {
    ...
    result.forEach(async(x, i) => {
      if(x.status=='0' && x.type=='Job Bill'){
        ...
        `IFA-JB-${1}/${moment().format("YY")}`:
        `IFA-JB-${ parseInt(lastJB.invoice_Id)+1}/${moment().format("YY")}`
      }
      if(x.status=='0' && x.type=='Job Invoice'){
        ...
        `IFA-JI-${1}/${moment().format("YY")}`:
        `IFA-JI-${ parseInt(lastJI.invoice_Id)+1}/${moment().format("YY")}`
      }
      if(x.status=='0' && x.type=='Agent Invoice'){
        ...
        `IFA-AI-${1}/${moment().format("YY")}`:
        `IFA-AI-${ parseInt(lastAI.invoice_Id)+1}/${moment().format("YY")}`
      }
      if(x.status=='0' && x.type=='Agent Bill'){
        ...
        `IFA-AB-${1}/${moment().format("YY")}`:
        `IFA-AB-${ parseInt(lastAB.invoice_Id)+1}/${moment().format("YY")}`
      }
    })
